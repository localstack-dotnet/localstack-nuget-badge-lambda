...
import { createLambdaEvent, expectRedirectResponse, expectErrorResponse } from '../../helpers/testUtils.mjs';
...
describe('Test Redirect Handler', () => {
  ...
  describe('Successful Redirects', () => {
    test('redirects to GitHub Actions URL when available', async () => {
      const testUrl = 'https://github.com/localstack-dotnet/localstack-dotnet-client/actions/runs/123456';
    ...
    test('handles complex GitHub Actions URLs', async () => {
      const complexUrl = 'https://github.com/localstack-dotnet/localstack-dotnet-client/actions/runs/7234567890/job/19876543210';
  ...
  describe('Fallback Handling', () => {
    test('redirects to fallback URL when primary URL is null', async () => {
      ...
      const expectedFallback = 'https://github.com/localstack-dotnet/localstack-dotnet-client/actions';
  ...
  describe('URL Validation', () => {
    ...
    test('handles URLs with query parameters', async () => {
      const urlWithQuery = 'https://github.com/localstack/repo/actions/runs/123?check_suite_id=456';
    ...
    test('handles URLs with fragments', async () => {
      const urlWithFragment = 'https://github.com/localstack/repo/actions/runs/123#summary';
    ...
    test('preserves URL encoding in redirects', async () => {
      const encodedUrl = 'https://github.com/localstack/repo/actions/runs/123?query=test%20data';
